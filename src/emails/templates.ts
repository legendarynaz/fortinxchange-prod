...
export const emailTemplates: Record<string, EmailTemplate> = {
  ...
  welcome: {
    ...
    body: params => `Hello,\n\nWelcome to 4ortin-X:Crypto Bitcoin Wallet! We are thrilled to have you.\n\nYour new User ID is: ${params.userId}\n\nPlease keep it safe. You will use this User ID to log in to your account.\n\nHappy trading,\nThe 4ortin-X:Crypto Bitcoin Wallet Team`
  },
  verifyEmail: {
    subject: 'Verify Your Email for 4ortin-X:Crypto Bitcoin Wallet',
    body: params => `Hello,\n\nPlease click the link below to verify your email address and complete your registration.\n\nVerification Link: ${params.verificationLink}\n\nIf you did not sign up for 4ortin-X:Crypto Bitcoin Wallet, please ignore this email.\n\nThanks,\nThe 4ortin-X:Crypto Bitcoin Wallet Team`
  },
  passwordReset: {
    subject: 'Your 4ortin-X:Crypto Bitcoin Wallet Password Reset Request',
  ...
  accountLocked: {
    subject: 'Security Alert: Your 4ortin-X:Crypto Bitcoin Wallet Account Has Been Locked',
    body: params => `Hello,\n\nYour 4ortin-X:Crypto Bitcoin Wallet account associated with User ID: ${params.userId} has been temporarily locked for 24 hours due to multiple failed login attempts.\n\nIf this was you, please wait for the lockout period to expire before trying again.\n\nIf this was not you, your account may be at risk. Please contact our support team immediately.\n\nThanks,\nThe 4ortin-X:Crypto Bitcoin Wallet Team`
  },
  ...
  kycRequired: {
    ...
    body: params => `Hello,\n\nTo continue using all features of 4ortin-X:Crypto Bitcoin Wallet, including transactions over ${params.threshold} USD, you need to complete identity verification.\n\nPlease log in to your account and follow the prompts to start the verification process.\n\nThanks,\nThe 4ortin-X:Crypto Bitcoin Wallet Team`
  },
  kycSubmitted: {
  ...
  kycApproved: {
    ...
    body: _params => `Hello,\n\nCongratulations! Your identity has been successfully verified. You now have full access to all features and limits on 4ortin-X:Crypto Bitcoin Wallet.\n\nHappy trading,\nThe 4ortin-X:Crypto Bitcoin Wallet Team`
  },
  kycRejected: {
  ...
  regionNotSupported: {
    ...
    body: _params => `Hello,\n\nThank you for your interest in 4ortin-X:Crypto Bitcoin Wallet. Unfortunately, our services are not currently available in your region.\n\nWe are working to expand our services and hope to support your region in the future.\n\nThanks,\nThe 4ortin-X:Crypto Bitcoin Wallet Team`
  },

  // --- Bank Accounts ---
  bankAccountAdded: {
    subject: 'New Bank Account Added',
    body: params => `Hello,\n\nA new bank account (${params.bankName} ending in ${params.last4}) has been successfully linked to your 4ortin-X:Crypto Bitcoin Wallet account.\n\nIf you did not authorize this, please contact support immediately.\n\nThanks,\nThe 4ortin-X:Crypto Bitcoin Wallet Team`
  },
  bankAccountRemoved: {
    subject: 'Bank Account Removed',
    body: params => `Hello,\n\nYour bank account (${params.bankName} ending in ${params.last4}) has been removed from your 4ortin-X:Crypto Bitcoin Wallet account.\n\nIf you did not authorize this, please contact support immediately.\n\nThanks,\nThe 4ortin-X:Crypto Bitcoin Wallet Team`
  }
};
